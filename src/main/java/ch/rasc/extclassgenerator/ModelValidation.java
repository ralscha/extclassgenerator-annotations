...
@Inherited
@Documented
@Repeatable(ModelValidations.class)
public @interface ModelValidation {
	...
	/**
	 * inclusion or exclusion list, valid only for {@link ModelValidationType#Exclusion}
	 * or {@link ModelValidationType#Inclusion}. Confer to <a href=
