...
/**
 * Annotation that configures different aspects of a model field. The annotation does not have to be present on the
 * field to be included in the generated JS code. The generator takes all public readable fields into account.
 */
...
public @interface ModelField {
	...
	/**
	 * Type of the field. Property '<a href="http://docs.sencha.com/ext-js/4-2/#!/api/Ext.data.Field-cfg-type"
	 * >type</a>' in JS. This is used for the new Ext JS 5 Custom Field Types feature.
	 * <p>
	 * If not present the library tries to figure out the type.
	 * <p>
	 * If {@link #type()} and {@link #customType()} are present {@link #customType()} has precedence.
	 */
	 ...
	 * <p>
	 * Can be set to {@link #DEFAULTVALUE_UNDEFINED} to set defaultValue to the value undefined. This prevents
	 * defaulting a value.
	 */
	 ...
	 * Property '<a href= "http://docs.sencha.com/ext-js/4-2/#!/api/Ext.data.Field-cfg-mapping" >mapping</a>' in JS.
	 * <p>
	 */
	 ...
	 * Property '<a href= "http://docs.sencha.com/ext-js/4-2/#!/api/Ext.data.Field-cfg-persist" >persist</a>' in JS.
	 * <p>
	 */
	 ...
	 * Typical use for a virtual field <br>
	 * Property '<a href= "http://docs.sencha.com/ext-js/4-2/#!/api/Ext.data.Field-cfg-convert" >
	...
	/**
	 * Constant for the value undefined. Can only be used for the property {@link #defaultValue()}. According to the <a
	 * href= "http://docs.sencha.com/ext-js/4-2/#!/api/Ext.data.Field-cfg-defaultValue" >documentation</a> setting
	 * defaultValue to undefined prevents defaulting a value.
	 */
